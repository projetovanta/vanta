      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
            <Flag size="1rem" className="text-white/40" />
          </div>
          <div>
            <p className="text-zinc-400 text-[0.5rem] font-black uppercase tracking-widest">Relatório Final</p>
        ...
        <div className="rounded-2xl bg-zinc-900/60 border border-white/5 divide-y divide-white/5">
          <div className="flex justify-between items-center px-4 py-3">
            <p className="text-zinc-400 text-[0.625rem] font-black uppercase tracking-wider">Check-ins realizados</p>
            <p className="text-white font-black text-sm">{checkinsEvento}</p>
          </div>
          <div className="flex justify-between items-center px-4 py-3">
            <p className="text-zinc-400 text-[0.625rem] font-black uppercase tracking-wider">Receita Bruta</p>
            <p className="text-zinc-300 font-black text-sm">{fmtBRL(receitaBrutaEvento)}</p>
          </div>
          <div className="flex justify-between items-center px-4 py-3">
            <p className="text-zinc-400 text-[0.625rem] font-black uppercase tracking-wider">Saldo a Transferir</p>
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={onEncerrar}
            className="flex-1 h-12 rounded-xl font-black text-[0.625rem] uppercase tracking-widest flex items-center justify-center gap-2 active:scale-[0.97] transition-all"
            style={{ background: 'linear-gradient(135deg, #059669, #10b981)', color: '#fff' }}
          >
            <Check size="0.875rem" /> Confirmar Encerramento
          </button>
        </div>
      </div>
    </div>
