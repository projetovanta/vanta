            ...
            <div className="grid grid-cols-2 gap-2.5 mb-4">
              <div className="bg-zinc-900/50 border border-white/5 rounded-xl p-3 flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[8px] text-zinc-500 font-black uppercase tracking-wider">Vendas</p>
                </div>
              ...
              <div className="bg-zinc-900/50 border border-white/5 rounded-xl p-3 flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[8px] text-zinc-500 font-black uppercase tracking-wider">Valor Total</p>
                </div>
              ...
              <div className="bg-zinc-900/50 border border-white/5 rounded-xl p-3 flex flex-col gap-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <p className="text-[8px] text-zinc-500 font-black uppercase tracking-wider">Disponíveis</p>
                </div>
                  ...
                  {metricas.map(m => {
                    ...
                    return (
                      <div key={m.eventoId} className="bg-zinc-900/50 border border-white/5 rounded-xl p-3">
                        ...
                        <p className="text-[9px] text-zinc-600 mt-1">{fmtBRL(m.vendasValor)}</p>
                      </div>
                    );
                  })}
                </div>
                    ...
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] text-zinc-500 truncate">{m.eventoNome}</p>
                        </div>
                      </div>
