  ...
  >
    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        />
        {valorNum > valorMax && (
          <p className="text-red-400 text-[9px] font-black uppercase tracking-widest">Excede o saldo disponível</p>
        )}
      </div>
      ...
      {valorNum > 0 && (
        <div className="rounded-xl p-4 space-y-2 border bg-zinc-900/60 border-white/5">
          ...
          <div className="border-t border-white/5 pt-2 flex justify-between items-center">
            <p className="text-zinc-300 text-[10px] font-black uppercase tracking-wider">Líquido a receber</p>
