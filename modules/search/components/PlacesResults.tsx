    ...
    <div className="space-y-2 px-1">
      {results.map(place => (
        <button
          ...
          className="w-full flex items-center gap-3 p-3 rounded-2xl bg-zinc-900/40 border border-white/5 text-left active:scale-[0.98] transition-all hover-real:border-white/10"
        >
