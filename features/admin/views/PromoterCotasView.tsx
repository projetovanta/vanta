      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-5 space-y-4">
        ...
        <div>
          ...
          <div className="bg-zinc-900/50 border border-white/5 rounded-xl overflow-hidden">
            <div className="grid grid-cols-[1fr_auto_auto_auto] gap-x-3 px-4 py-2 border-b border-white/5">
              ...
              <p className="text-[7px] text-zinc-700 font-black uppercase tracking-widest text-right">Alocado</p>
              <p className="text-[7px] text-zinc-700 font-black uppercase tracking-widest text-right">Usado</p>
              <p className="text-[7px] text-zinc-700 font-black uppercase tracking-widest text-right">Saldo</p>
            </div>
            {cotasPromoter.length === 0 ? (
              <p className="text-zinc-700 text-[10px] italic px-4 py-3">Sem cotas atribuídas</p>
            ) : (
        ...
        <div>
          ...
          {meusConvidados.length === 0 ? (
            <p className="text-zinc-700 text-[10px] italic">Nenhum convidado inserido ainda.</p>
          ) : (
