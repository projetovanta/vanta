        ...
        {activeFilterCount > 0 && (
          <div className="flex flex-wrap gap-1.5 mt-2.5">
            ...
            <button
              ...
              className="px-2.5 py-1 rounded-full text-[8px] font-black uppercase tracking-wider text-zinc-600 active:text-zinc-400 transition-all"
            >
              Limpar
            </button>
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-zinc-600 text-[10px] truncate mb-1">{m.email}</p>
                  {(m.cidade || m.estado) && (
