      ...
      <div className="bg-[#0A0A0A]/95 backdrop-blur-xl border-b border-white/5 px-6 pt-8 pb-4 shrink-0">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest mb-0.5">Análise</p>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar p-6 max-w-3xl mx-auto w-full space-y-8">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-zinc-600 text-xs">Nenhum participante com perfil encontrado</p>
            {totalTickets > 0 && (
          ...
          <>
            {generoData.length > 0 && (
              <div>
                <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest mb-4">Gênero</p>
                <VantaPieChart data={generoData} height={140} />
              </div>
            )}
            {idadeData.length > 0 && (
              <div>
                <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest mb-4">Faixa Etária</p>
                <VantaPieChart data={idadeData} height={140} />
              </div>
            )}
            {cidadeData.length > 0 && (
              <div>
                <p className="text-[8px] text-zinc-600 font-black uppercase tracking-widest mb-4">Cidade</p>
