    ...
    <div className="absolute inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="w-[90%] max-w-xs bg-[#111111] border border-white/10 rounded-3xl p-6 flex flex-col items-center gap-4">
        ...
        <button
          ...
          className="w-full py-3 bg-[#FFD300] text-black text-[0.625rem] font-black uppercase tracking-[0.3em] rounded-xl flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
        >
          <LogIn size="0.875rem" strokeWidth={2.5} />
          Entrar novamente
        </button>
      </div>
    </div>
