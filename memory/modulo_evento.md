...
| Vanta Indica | features/admin/views/VantaIndicaView.tsx | Card (snap, cqw, 6 ações, 7 templates hardcoded + templates DB, emoji picker 24, paleta 8 cores, badgeColor custom, preview fiel à Home) |
