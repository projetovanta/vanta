  ...
  >
    ...
    >
      ...
      <div className="px-6 pt-4 pb-2">
        <p className="text-[#FFD300] text-[8px] font-black uppercase tracking-widest mb-2">
      ...
      <div className="px-6 pt-4 flex gap-3" style={{ paddingBottom: 'max(2rem, env(safe-area-inset-bottom, 2rem))' }}>
        ...
        <button
          onClick={onConfirmar}
          className="flex-1 py-4 bg-[#FFD300] text-black font-bold text-[10px] uppercase tracking-widest rounded-xl active:scale-95 transition-all"
        >
          Sim, Continuar
        </button>
      </div>
