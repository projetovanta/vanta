...
export const ComunidadeDetalheView: React.FC<{
  ...
  return (
    <div className="absolute inset-0 bg-[#0A0A0A] flex flex-col overflow-hidden">
      ...
      {/* Hero cover */}
      <div className="relative shrink-0 aspect-[16/7] max-h-[240px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-6 pb-5">
          <div className="flex items-center gap-1.5 mb-1.5">
            <MapPin size={9} className="text-[#FFD300]/70" />
            <p className="text-[#FFD300]/70 text-[9px] font-black uppercase tracking-[0.2em]">{comunidade.cidade}</p>
          </div>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar max-w-3xl mx-auto w-full">
        <div className="px-6 pt-4 pb-3">
          ...
          <p className="text-zinc-700 text-[10px] mb-4 truncate">{comunidade.endereco}</p>
          ...
          {tab === 'EVENTOS' && (
            ...
            >
              <div className="min-w-0">
                ...
                <p className="text-black/50 text-[10px] font-bold mt-1">Criar · Próximos · Encerrados</p>
              </div>
