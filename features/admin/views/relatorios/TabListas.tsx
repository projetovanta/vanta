...
export const TabListas: React.FC<Props> = ({ listas, role, currentUserId }) => {
  ...
  const SUB_TABS: { id: SubTab; label: string; icon: React.ReactNode }[] = [
    { id: 'PROMOTERS', label: 'Promoters', icon: <Users size={11} /> },
    { id: 'POR_LISTA', label: 'Por Lista', icon: <List size={11} /> },
    { id: 'PORTARIA', label: 'Portaria', icon: <Shield size={11} /> },
    { id: 'CONVIDADOS', label: 'Convidados', icon: <UserCheck size={11} /> },
  ];
