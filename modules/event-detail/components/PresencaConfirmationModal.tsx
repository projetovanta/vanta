...
export const PresencaConfirmationModal: React.FC<PresencaConfirmationModalProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-[250] flex items-center justify-center p-6 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-[340px] bg-[#0A0A0A] border border-[#FFD300]/20 rounded-[2.5rem] p-8 text-center shadow-[0_0_50px_rgba(255,211,0,0.1)] animate-in zoom-in-95 duration-500">
        ...
        <div className="space-y-3">
          ...
          >
            <Link size={14} className="text-[#FFD300]" />
            {copied ? 'Copiado ✓' : 'Copiar Link'}
          </button>

          <button
            onClick={onInviteFriends}
            className="w-full py-4 bg-[#FFD300] text-black font-bold text-[10px] uppercase tracking-[0.2em] rounded-xl shadow-xl active:scale-95 transition-all flex items-center justify-center gap-2"
          >
            <Users size={14} />
