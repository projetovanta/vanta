            ...
            <>
              ...
              <div className="space-y-2.5">
                <button
                  ...
                  disabled={loading}
                  className="w-full min-h-[2.75rem] flex items-center justify-center gap-2.5 bg-white text-black font-bold text-[0.6875rem] uppercase tracking-[0.15em] rounded-xl active:scale-95 transition-all disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full min-h-[2.75rem] flex items-center justify-center gap-2.5 bg-zinc-800 border border-white/10 text-white font-bold text-[0.6875rem] uppercase tracking-[0.15em] rounded-xl active:scale-95 transition-all disabled:opacity-50"
                >
              ...
              <div className="flex items-center gap-3">
                ...
                <p className="text-white/30 text-[0.5625rem] font-bold uppercase tracking-widest">ou</p>
                <div className="flex-1 h-px bg-white/10" />
              </div>
