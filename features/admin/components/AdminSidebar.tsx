...
const COR = {
  ...
  MAIS_VANTA: '#FFD300',
  PLATAFORMA: '#8B8B8B',
  SISTEMA: '#525252', // usado pela community sidebar
} as const;
...
export const SIDEBAR_SECTIONS: SidebarSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'CARGOS', label: 'Cargos', icon: ShieldPlus, color: COR.COMUNIDADES, roles: ['vanta_masteradm'] },
      { id: 'AUDIT_LOG', label: 'Audit Log', icon: ClipboardList, color: COR.COMUNIDADES, roles: ['vanta_masteradm'] },
    ],
  },
  {
    label: 'EVENTOS',
    items: [
      ...
      { id: 'PENDENTES', label: 'Pendentes', icon: ClipboardList, color: COR.EVENTOS, roles: ['vanta_masteradm'] },
      {
        id: 'PORTARIA_QR',
        label: 'Portaria',
        icon: QrCode,
      ...
      },
      {
        ...
        icon: ShoppingCart,
        color: COR.EVENTOS,
        roles: ['vanta_masteradm', 'vanta_gerente', 'vanta_caixa'],
      },
      {
        id: 'LISTAS',
        label: 'Listas',
        icon: ListChecks,
        color: COR.EVENTOS,
        roles: ['vanta_masteradm', 'vanta_gerente', 'vanta_promoter'],
      },
    ],
  },
  {
  ...
  },
  {
    label: 'PLATAFORMA',
    items: [
      { id: 'GESTAO_USUARIOS', label: 'Usuários', icon: Users, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      { id: 'CATEGORIAS', label: 'Categorias', icon: Tag, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      {
        id: 'CONFIG_PLATAFORMA',
        label: 'Taxas e Splits',
        icon: Settings,
        color: COR.PLATAFORMA,
        roles: ['vanta_masteradm'],
      },
      { id: 'NOTIFICACOES', label: 'Notificações', icon: Bell, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      { id: 'INDICA', label: 'Vanta Indica', icon: Compass, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      { id: 'SITE_CONTENT', label: 'Textos do App', icon: FileText, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      { id: 'LEGAL_EDITOR', label: 'Legal', icon: Scale, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
      { id: 'DIAGNOSTICO', label: 'Diagnóstico', icon: Activity, color: COR.PLATAFORMA, roles: ['vanta_masteradm'] },
    ],
  },
];
