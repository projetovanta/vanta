  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-3">
        ...
        <p className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest">Gerando relatório...</p>
      </div>
    );
  }
  ...
  if (!rel) {
    return (
      <div className="flex flex-col items-center py-16 gap-3">
        <FileText size="1.75rem" className="text-zinc-800" />
        <p className="text-zinc-700 text-[0.625rem] font-black uppercase tracking-widest">Evento não encontrado</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4 print:bg-white print:text-black" id="vanta-relatorio">
      ...
      <div className="flex items-center gap-2">
        <FileText size="0.875rem" className="text-[#FFD300] print:text-black" />
        <p className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest print:text-gray-600">
      ...
      <div className="p-4 bg-zinc-900/40 border border-white/5 rounded-2xl print:bg-gray-50 print:border-gray-200">
        ...
        <p className="text-zinc-400 text-[0.625rem] mt-1 print:text-gray-500">
      ...
      <div className="grid grid-cols-2 gap-2">
        {[
          ...
          >
            <p className="text-zinc-400 text-[0.5rem] font-black uppercase tracking-widest print:text-gray-500">
              {k.label}
            </p>
      ...
      <div className="p-4 bg-zinc-900/40 border border-white/5 rounded-2xl flex items-center justify-between print:bg-gray-50 print:border-gray-200">
        <p className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest print:text-gray-500">
          Ticket Médio
        </p>
      ...
      {/* Vendas por Origem */}
      <p className="text-zinc-700 text-[0.5625rem] font-black uppercase tracking-widest px-1 print:text-gray-600">
        Vendas por Origem
      </p>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2.5">
        {origens.map(o => (
          ...
          >
            <p className="text-zinc-400 text-[0.5625rem] font-bold uppercase tracking-wider print:text-gray-500">
              {o.label}
            </p>
            ...
            <p className={`text-[0.5625rem] font-black ${o.corTw}`}>{o.ci} check-ins</p>
          </div>
        ))}
      </div>
      ...
      {fatiasVariacao.length > 0 && (
        <div className="p-5 bg-zinc-900/40 border border-white/5 rounded-2xl print:bg-gray-50 print:border-gray-200">
          <p className="text-zinc-400 text-[0.5rem] font-black uppercase tracking-widest mb-4 print:text-gray-500">
      ...
      {/* Check-ins */}
      <div className="p-5 bg-zinc-900/40 border border-white/5 rounded-2xl print:bg-gray-50 print:border-gray-200">
        <p className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest mb-3 print:text-gray-500">
          Check-ins
        </p>
        ...
        <div className="flex gap-5">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest print:text-gray-500">
      ...
      <div className="p-5 bg-zinc-900/40 border border-white/5 rounded-2xl print:bg-gray-50 print:border-gray-200">
        ...
        {rel.reviewCount > 0 ? (
          <div className="flex items-center gap-3">
            ...
            <span className="text-zinc-400 text-[0.5625rem] font-black print:text-gray-500">
              ({rel.reviewCount} avaliações)
            </span>
          </div>
        ) : (
          <p className="text-zinc-700 text-[0.625rem] font-black uppercase tracking-widest print:text-gray-400">
            Sem avaliações
          </p>
        )}
      </div>
      ...
      <div className="p-5 bg-zinc-900/40 border border-white/5 rounded-2xl space-y-2 print:bg-gray-50 print:border-gray-200">
        <p className="text-zinc-400 text-[0.5625rem] font-black uppercase tracking-widest mb-2 print:text-gray-500">
          Resumo Financeiro
        </p>
        <div className="flex justify-between items-center">
          <p className="text-zinc-400 text-[0.625rem] print:text-gray-600">Receita Bruta</p>
          <p className="text-white text-[0.625rem] font-black print:text-black">{fmtBRL(rel.receitaBruta)}</p>
        </div>
        <div className="flex justify-between items-center">
          <p className="text-zinc-400 text-[0.625rem] print:text-gray-600">
            Taxa VANTA ({(rel.feePercent * 100).toFixed(1)}%)
          </p>
          <p className="text-red-400 text-[0.625rem] font-black print:text-red-600">- {fmtBRL(rel.valorTaxa)}</p>
        </div>
        <div className="h-px bg-white/5 my-1 print:bg-gray-200" />
        <div className="flex justify-between items-center">
          <p className="text-zinc-300 text-[0.625rem] font-black uppercase tracking-widest print:text-gray-700">
            Receita Líquida
          </p>
          <p className="text-emerald-400 text-sm font-black print:text-green-600">{fmtBRL(rel.receitaLiquida)}</p>
        </div>
        <div className="mt-2">
          <span className="px-2 py-0.5 rounded-full text-[0.5rem] font-black uppercase tracking-widest bg-[#FFD300]/10 border border-[#FFD300]/20 text-[#FFD300]/70">
            Taxa Serviço: Cliente
          </span>
          <span
            className={`ml-1 px-2 py-0.5 rounded-full text-[0.5rem] font-black uppercase tracking-widest ${
        ...
        <div className="bg-zinc-900/60 border border-[#FFD300]/10 rounded-2xl p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-black/30 rounded-xl p-3 text-center">
              ...
              <p className="text-zinc-500 text-[0.5rem] uppercase tracking-widest">Resgates</p>
            </div>
            <div className="bg-black/30 rounded-xl p-3 text-center">
              ...
              <p className="text-zinc-500 text-[0.5rem] uppercase tracking-widest">Comparecimento</p>
            </div>
            <div className="bg-black/30 rounded-xl p-3 text-center">
              <p className="text-white text-lg font-black">
                {mvStats.postsEnviados}/{mvStats.postsObrigatorios || '—'}
              </p>
              <p className="text-zinc-500 text-[0.5rem] uppercase tracking-widest">Posts enviados</p>
            </div>
            <div className="bg-black/30 rounded-xl p-3 text-center">
              <p className="text-white text-lg font-black">
                {mvStats.postsVerificados}/{mvStats.postsObrigatorios || '—'}
              </p>
              <p className="text-zinc-500 text-[0.5rem] uppercase tracking-widest">Posts verificados</p>
            </div>
            <div className="bg-black/30 rounded-xl p-3 text-center">
              ...
              <p className="text-zinc-500 text-[0.5rem] uppercase tracking-widest">Alcance estimado</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl text-[0.625rem] font-black uppercase tracking-wider border transition-all active:scale-95 ${
                mvAvaliacao === 'eficiente'
                  ? 'bg-emerald-500/20 border-emerald-500/40 text-emerald-400'
                  : 'bg-zinc-900/40 border-white/5 text-zinc-500'
              }`}
            >
              <ThumbsUp size="0.75rem" /> Eficiente
            </button>
            <button
            ...
            >
              <ThumbsDown size="0.75rem" /> Ineficiente
            </button>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-white/5">
            {!showNotifForm ? (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-zinc-800 border border-white/5 text-zinc-300 text-[0.625rem] font-black uppercase tracking-wider active:scale-95 transition-all"
              >
                <Bell size="0.75rem" />
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl bg-[#FFD300]/10 border border-[#FFD300]/20 text-[#FFD300] text-[0.625rem] font-black uppercase tracking-wider active:scale-95 transition-all disabled:opacity-50"
                  >
                    <Send size="0.75rem" />
                    Enviar solicitação
                  </button>
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-zinc-800 border border-white/5 text-zinc-400 text-[0.625rem] font-black uppercase tracking-wider active:scale-95 transition-all"
                  >
                    Cancelar
                  </button>
                </div>
      ...
      <button
        ...
        className="w-full py-4 bg-[#FFD300]/10 border border-[#FFD300]/20 rounded-2xl flex items-center justify-center gap-2 text-[#FFD300] text-[0.625rem] font-black uppercase tracking-widest active:scale-[0.98] transition-all print:hidden"
      >
        <Printer size="0.875rem" />
        Exportar PDF
      </button>
    </div>
  );
