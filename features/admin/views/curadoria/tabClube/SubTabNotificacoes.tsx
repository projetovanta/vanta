...
export const SubTabNotificacoes: React.FC = () => (
  <div className="space-y-4">
    <div className="bg-zinc-900/60 border border-white/5 rounded-2xl p-4 space-y-3">
      ...
      <ul className="text-zinc-400 text-[0.625rem] space-y-1 ml-3 list-disc">
    ...
    <div className="bg-zinc-900/60 border border-white/5 rounded-2xl p-4 space-y-3">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <p className="text-zinc-400 text-[0.5625rem] mt-1">Para esta comunidade</p>
        </div>
        <button className="px-3 py-1.5 bg-[#FFD300]/10 border border-[#FFD300]/25 rounded-lg text-[#FFD300] text-[0.5rem] font-bold active:scale-95 transition-all">
          ATIVAR
        </button>
      </div>
    </div>
    ...
    <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-4 space-y-2">
      ...
      <p className="text-amber-200/80 text-[0.5625rem] leading-relaxed">
    ...
    <div className="text-zinc-400 text-[0.5625rem] text-center py-6">
